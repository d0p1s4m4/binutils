...
#define TARGET_SYM		i386_coff_stupidos_vec
#define TARGET_NAME		"coff-stupidos"
...
bool _bfd_stupidos_mkobject (bfd *);
void _bfd_stupidos_swap_scnhdr_in (bfd *, void *, void *);
unsigned int _bfd_stupidos_swap_scnhdr_out (bfd *, void *, void *);

#define coff_mkobject _bfd_stupidos_mkobject
#define coff_SWAP_scnhdr_in _bfd_stupidos_swap_scnhdr_in
#define coff_SWAP_scnhdr_out _bfd_stupidos_swap_scnhdr_out

#include "coff-i386.c"

bool
_bfd_stupidos_mkobject (bfd * abfd)
{
...
void
_bfd_stupidos_swap_scnhdr_in (bfd * abfd, void * ext, void * in)
{
...
unsigned int
_bfd_stupidos_swap_scnhdr_out (bfd * abfd, void * in, void * out)
{
  struct internal_scnhdr *scnhdr_int = (struct internal_scnhdr *) in;
